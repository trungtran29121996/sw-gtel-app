class DataCnpRouteByIdReponse {
  ...
  FromFleetAddressInfo? fromFleetAddressInfo;
  dynamic toFleetAddressInfo;

  DataCnpRouteByIdReponse({
    this.createdAt,
    this.modifiedAt,
    this.memberCreated,
    this.memberUpdated,
  ...
  factory DataCnpRouteByIdReponse.fromJson(Map<String, dynamic> json) =>
      DataCnpRouteByIdReponse(
        ...
        routeRequestList: json["route_request_list"] == null
            ? []
            : List<RouteRequestList>.from(json["route_request_list"]!
                .map((x) => RouteRequestList.fromJson(x))),
        sequenceList: json["sequence_list"] == null
            ? []
            : List<SequenceList>.from(
                json["sequence_list"]!.map((x) => SequenceList.fromJson(x))),
        fromFleetAddressInfo: json["from_fleet_address_info"] == null
            ? null
            : FromFleetAddressInfo.fromJson(json["from_fleet_address_info"]),
        toFleetAddressInfo: json["to_fleet_address_info"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "from_fleet_address_info": fromFleetAddressInfo?.toJson(),
        "to_fleet_address_info": toFleetAddressInfo,
      };
}

class FromFleetAddressInfo {
  int? createdAt;
  int? modifiedAt;
  int? memberCreated;
  int? memberUpdated;
  ...
  factory FromFleetAddressInfo.fromJson(Map<String, dynamic> json) =>
      FromFleetAddressInfo(
        createdAt: json["created_at"],
        modifiedAt: json["modified_at"],
        memberCreated: json["member_created"],
...
class RouteRequestList {
  String? id;
  int? routeId;
  int? requestId;
  int? status;
  int? seqIndex;
  RequestInfoByID? requestInfo;
  ...
  factory RouteRequestList.fromJson(Map<String, dynamic> json) =>
      RouteRequestList(
        id: json["id"],
        routeId: json["route_id"],
        ...
        requestInfo: json["request_info"] == null
            ? null
            : RequestInfoByID.fromJson(json["request_info"]),
      );
...
class RequestInfoByID {
  ...
  factory RequestInfoByID.fromJson(Map<String, dynamic> json) =>
      RequestInfoByID(
        createdAt: json["created_at"],
        modifiedAt: json["modified_at"],
        memberCreated: json["member_created"],
        ...
        pickupTimePreferred: json["pickup_time_preferred"] == null
            ? ""
            : json["pickup_time_preferred"],
        ...
        listSalePayment: json["list_sale_payment"] == null
            ? []
            : List<dynamic>.from(json["list_sale_payment"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "list_sale_payment": listSalePayment == null
            ? []
            : List<dynamic>.from(listSalePayment!.map((x) => x)),
        "total_fee": totalFee,
